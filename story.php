...
?>
	...
	<div id="met">
		<img src="img/universal.jpg" alt="Callie and Grant at Universal Studios" width="150" height="150"/>
		<h2>How We Met</h2>
			...
			<img  src="img/castle.jpg" alt="Callie and Grant in front of Cinderella Castle" width="168" height= "245" class="second"/>
	</div>
	
	<div id="proposal">
		<img src="img/dream2.jpg" alt="Callie's ring" width="150" height="150"/>
		<h2>Our Proposal</h2>
		<p>On December 8th Callie & Grant embarked on the Disney Dream for a 4-night cruise to the Bahamas. This was their joint Christmas present for each other for 2013 and they were both very much looking forward to it.</p>
		...
		<img src="img/dream1.jpg" alt="Callie and Grant on the Disney Dream"width="168" height= "245" class="second"/>
