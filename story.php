...
?>
	...
	<div id="callie">
		...
		<h2>Callie</h2>
			<div id="Callie's Story" class="cushycms">
	...
	<div id="grant">
		...
		<h2>Grant</h2>
			<div id="Grant's Story" class="cushycms">
	...
	<img class="right" src="img/castle.jpg" alt="Callie and Grant in front of Cinderella Castle" width="168" height= "245"/>
		...
		<h2>How We Met</h2>
		<div id="How We Met" class="cushycms">
			<p> Callie & Grant met in 2010 at Cinderella’s Royal Table inside Cinderella Castle at Magic Kingdom. Their first  encounter was in January of 2010 when Callie thought Grant was basically a huge jerk.</p>
	...
	<div id="proposal">
		...
		<h2>Our Proposal</h2>
		<div id ="Our Proposal" class="cushycms">
